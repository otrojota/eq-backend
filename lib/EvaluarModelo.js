...
class EvaluarModelo extends Proceso {
    static get instance() { return EvaluarModelo._singleton ||= new EvaluarModelo(); }
    get codigo() { return "evaluar-modelo"; }
    get nombre() { return "Evaluar Modelo"; }
    get descripcion() { return "Evalua el modelo mediante trayectorias y cortes historicos"; }
...
export default Proceso.registra(EvaluarModelo.instance);
